...
func main() {
	...
	router.HandleFunc("/users/{id}", server.UpdateUser).Methods(http.MethodPut)    // PUT route
	router.HandleFunc("/users/{id}", server.DeleteUser).Methods(http.MethodDelete) // DELETE route
